...
export default function FloatingPromoOffers() {
  return (
    <div className="pointer-events-none absolute inset-0 hidden lg:block" aria-hidden="true">
      <div className="pointer-events-none absolute -right-20 -top-20 h-96 w-96 rounded-full bg-lime-500/25 blur-3xl" />
      ...
      <div className="pointer-events-none absolute top-1/3 right-8 h-48 w-48 rounded-full border border-lime-400/15" />
